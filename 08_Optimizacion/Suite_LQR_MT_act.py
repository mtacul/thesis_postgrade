...
###############################################################################################################################################
    ...
    for i in range(len(t)-1):
        ...
        u_estt = np.dot(-K,x_est)
        u_est = functions_08.torquer(u_estt,lim)
...
##### Encontrar el tiempo de asentamiento en segundos de cada angulo de Euler
    ...
    settling_error_sup_R = np.full(len(t),settling_band_R)
    settling_error_inf_R = np.full(len(t),-settling_band_R)

    settling_error_sup_P = np.full(len(t),settling_band_P)
    settling_error_inf_P = np.full(len(t),-settling_band_P)

    settling_error_sup_Y = np.full(len(t),settling_band_Y)
    settling_error_inf_Y = np.full(len(t),-settling_band_Y)
...
##### Asentamientos 
    ...
    if settling_time_indices_R_1:
        ...
        for start, end in settling_time_indices_R_1:
            settling_times_R_1.append((t[start], t[end]))
    else:
    ...
    if settling_time_indices_P_1:
        ...
        for start, end in settling_time_indices_P_1:
            settling_times_P_1.append((t[start], t[end]))
    else:
        print("La señal no entra en la banda de asentamiento.")
    ...
    if settling_time_indices_Y_1:
        ...
        for start, end in settling_time_indices_Y_1:
            settling_times_Y_1.append((t[start], t[end]))
    else:
        print("La señal no entra en la banda de asentamiento.")
    ...
    if settling_time_indices_norm_1:
        ...
        for start, end in settling_time_indices_norm_1:
            settling_times_norm_1.append((t[start], t[end]))
    else:
        print("La señal no entra en la banda de asentamiento.")
