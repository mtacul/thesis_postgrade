...
def suite_sim(sigma_ss, sigma_b):
    ...
    b_body_i = functions_08.rotacion_v(q_real, bi_orbit, 1e-6)
    
    si_orbit = [vx_sun_orbit[0],vy_sun_orbit[0],vz_sun_orbit[0]]
    s_body_i = functions_08.rotacion_v(q_real, si_orbit, 0.036)
    hh =0.01
    ...
    for i in range(len(t)-1):
        ...
        x_real = xx_new_d
        w_gyros = functions_08.simulate_gyros_reading(x_real[3:6],ruido_w,bias_w)
    ...
    Roll_high_pass_1 = functions_08.high_pass_filter(Roll_1, 10, len(t))
    Pitch_high_pass_1 = functions_08.high_pass_filter(Pitch_1, 10, len(t))
    Yaw_high_pass_1 = functions_08.high_pass_filter(Yaw_1, 10, len(t))
...
##### Asentamientos 
    ...
    return accuracy_norms, norm_psd_RPY_1
