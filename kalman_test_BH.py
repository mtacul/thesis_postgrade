...
Bi = np.array([-1.5395762648448995e-05,1.4470084691495847e-06,2.95526952235141e-05])

[A,B,C,A_discrete,B_discrete,C_discrete] = functions_tesis.A_B(I_x, I_y, I_z, w0_O, w0, w1, w2, deltat, hh, Bi,Bi)
...
for i in range(len(t)-1):
    ...
    [q_posteriori, w_posteriori, P_k_pos,K_k] = functions_tesis.kalman_lineal(A_discrete, B_discrete, x_est, u_est, b_orbit, b_body, P_ki, 1e-6, 0.036, deltat,w_gyros,hh)
    # asasd
    ...
    # ww_real = functions_tesis.simulate_gyros_reading(www_real, 0,0)
